...
#ifdef WIN32
#   define VK_KHR_EXTERNAL_MEMORY_EXT_NAME VK_KHR_EXTERNAL_MEMORY_WIN32_EXTENSION_NAME
#   define VK_KHR_EXTERNAL_SEMAPHORE_EXT_NAME VK_KHR_EXTERNAL_SEMAPHORE_WIN32_EXTENSION_NAME
#else
#   define VK_KHR_EXTERNAL_MEMORY_EXT_NAME VK_KHR_EXTERNAL_MEMORY_FD_EXTENSION_NAME
#   define VK_KHR_EXTERNAL_SEMAPHORE_EXT_NAME VK_KHR_EXTERNAL_SEMAPHORE_FD_EXTENSION_NAME
#endif
